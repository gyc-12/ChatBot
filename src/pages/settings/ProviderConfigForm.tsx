  ...
  return (
    <>
      ...
      {props.showBaseFields && (
        <div className="mb-4 overflow-hidden rounded-xl ring-1 ring-[color:color-mix(in_srgb,var(--border)_40%,transparent)]" style={{ backgroundColor: "var(--card)" }}>
          <FormRow label={t("providerEdit.name")}>
            <input
              className="text-foreground flex-1 bg-transparent text-[15px] outline-none"
              value={props.name}
      ...
      <div className="mb-4 overflow-hidden rounded-xl ring-1 ring-[color:color-mix(in_srgb,var(--border)_40%,transparent)]" style={{ backgroundColor: "var(--card)" }}>
        <div className="flex items-center px-4 py-3.5">
          <IoKeyOutline size={17} color="var(--muted-foreground)" className="mr-3 flex-shrink-0" />
          <input
      ...
      <button
        ...
        className="mb-2 flex w-full items-center justify-between border-t border-[color:color-mix(in_srgb,var(--border)_30%,transparent)] px-1 pt-4 pb-2"
      >
