...
export function ProviderEditPage({ editId, onClose }: { editId?: string; onClose?: () => void }) {
  ...
  return (
    <div className="h-full overflow-y-auto" style={{ backgroundColor: "var(--background)" }}>
      <div className="mx-auto max-w-lg px-4 pt-5 pb-8">
              ...
              {(
                ...
                return (
                  <button
                    ...
                    className="rounded-lg px-3.5 py-1.5 text-[13px] font-medium transition-colors duration-200"
                    style={{
        ...
        <div className="mt-5 flex gap-3">
          <button
            className="flex flex-1 items-center justify-center rounded-2xl py-3.5 text-[15px] font-semibold text-white transition-opacity duration-200 active:opacity-80 disabled:opacity-50"
          ...
          <button
            onClick={handleSave}
            disabled={testing || pulling || !name.trim() || !baseUrl.trim()}
            className="flex items-center justify-center gap-1 rounded-2xl px-6 py-3.5 text-[15px] font-semibold text-white transition-opacity duration-200 active:opacity-80 disabled:opacity-50"
        ...
        {/* Security note */}
        <div className="flex items-center justify-center gap-1.5 px-6 pt-8 pb-6">
          <IoLockClosed size={11} color="var(--muted-foreground)" style={{ opacity: 0.4 }} />
