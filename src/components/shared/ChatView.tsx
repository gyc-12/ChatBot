...
export function ChatView({
  ...
  const latestTokenText = useMemo(() => {
    const withUsage = [...displayMessages].reverse().find((message) => message.tokenUsage);
    if (!withUsage?.tokenUsage) return undefined;
    return `${formatTokens(withUsage.tokenUsage.inputTokens + withUsage.tokenUsage.outputTokens)} TOKENS`;
  }, [displayMessages]);
    ...
    return (
      ...
      >
        ...
        <ChatInput
          ...
          isMobile={isMobile}
          floatingBadgeText={latestTokenText}
