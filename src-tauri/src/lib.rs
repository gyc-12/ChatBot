...
fn check_pending_import(app: tauri::AppHandle) -> Option<String> {
  ...
  // Known Android paths
  candidates.push(PathBuf::from("/data/data/com.gyc-12.ChatBot/files/pending_import.json"));
  candidates.push(PathBuf::from("/data/user/0/com.gyc-12.ChatBot/files/pending_import.json"));
